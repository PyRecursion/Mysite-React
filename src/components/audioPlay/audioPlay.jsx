...
class AudioPlay extends Component {
  ...
  //   console.log(111,nextProps, prevState)
  //   // const musicList=nextProps.musicList
  ...
  //   //   }
  //   // }
  // //   if(musicList.length===prevState.musicList.length){
  // //   return {
  // //     flag:Math.ceil(Math.random()*10)
  // //   }
  // // }
  // }
  // static getDerivedStateFromProps(nextProps, prevState) {
  //   console.log(nextProps, prevState)
  //   const { currentMusic, musicList: prevMusicList } = prevState; //prevMusicList=prevState.musicList
  //   const { musicList = [] } = nextProps; //musicList=nextProps.musicList
  //   // 判断音乐列表已经不同了
  //   console.log(111,musicList, prevMusicList)
